...
public class Gui_Left_Menus implements ActionListener {
    JFrame f;
    JButton profile_B,student_B,staff_B,exam_B,result_B,bill_B;
    Gui_Left_Menus(JFrame frame){
        f=frame;
        left_menus_init();

    }
    public void left_menus_init(){
        Color white,red;
    ...
    public void actionPerformed(ActionEvent e){
        if(e.getSource()==profile_B){
            JOptionPane.showMessageDialog(f,"profile_B");
        }
        else if(e.getSource()==student_B) {
            JOptionPane.showMessageDialog(f,"student_B");
        }
        if(e.getSource()==staff_B){
            JOptionPane.showMessageDialog(f,"staff_B");
        }
        else if(e.getSource()==exam_B) {
            JOptionPane.showMessageDialog(f,"exam_B");
        }
        if(e.getSource()==result_B){
            JOptionPane.showMessageDialog(f,"result_B");
        }
        else if(e.getSource()==bill_B) {
            JOptionPane.showMessageDialog(f,"bill_B");
        }
    }
